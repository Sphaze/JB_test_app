...
class Post(models.Model):
    ...
    description_of_issue = models.TextField(default="")
    root_cause_of_issue = models.TextField(default="")
    containment_action = models.TextField(default="")
    corrective_action = models.TextField(default="")
    validation_action = models.TextField(default="")
    issue_affects_other_areas = models.CharField(max_length=1, choices=control_field_2.choices, default=control_field_2.NO)
    clarify_issue = models.TextField(blank=True, default="")
